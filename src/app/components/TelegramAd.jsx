...
export default function TelegramAd() {
  ...
  const handleAdClick = async () => {
    ...
    try {
      // Check if the controller and triggerNativeNotification method are available
      if (
        window.TelegramAdsController &&
        window.TelegramAdsController.triggerNativeNotification
      ) {
        // Trigger the ad immediately (true means no creative display, just show the offer)
